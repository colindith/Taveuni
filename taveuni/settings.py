"""
Django settings for taveuni project.
...
SECRET_KEY = '_95tdwoahuqttl$eh5*uhgu&h!997=zzayqdl+u0x-@z(j@w9l'
...
WSGI_APPLICATION = 'taveuni.wsgi.application'
